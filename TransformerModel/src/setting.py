...
MODEL_NAME = 'proken2'  # モデル名


"""データベース作成"""
DATABASE_SAVE_DIR = "../database_data"
DATABASE_SAVE_FILE_NAME = "database.tar"
EVAL_DATABASE_SAVE_FILE_NAME = "eval_database.tar"

MAX_SENTENCE_LENGTH = 25  # 1文の最大単語数 この値より長い文は使わない。

# コーパスファイル名
corpus_data_names = ["です。tweet2020-10-04", "私はtweet2020-10-04"] #["あるtweet2020-04-09", "あるtweet2020-04-10", "です。tweet2020-04-09", "です。tweet2020-04-10", "です。tweet2020-04-11", "です。tweet2020-04-13",
...
LOAD_MODEL_EPOCH_NUM = 11       # 途中から学習を始める際 or 会話モードで使う 学習済みモデルのエポック数。
